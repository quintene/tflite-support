...
#ifndef TENSORFLOW_LITE_SUPPORT_CC_TASK_PROCESSOR_LEARNER_POSTPROCESSOR_H_
#define TENSORFLOW_LITE_SUPPORT_CC_TASK_PROCESSOR_LEARNER_POSTPROCESSOR_H_
...
class EmbeddingLearnerPostprocessor : public Postprocessor {
 public:
  static tflite::support::StatusOr<std::unique_ptr<EmbeddingLearnerPostprocessor>> Create(
  ...
  // Converts the tensor outputs to embeddings and append new embeddings to the index
  tflite::support::Status Postprocess();
